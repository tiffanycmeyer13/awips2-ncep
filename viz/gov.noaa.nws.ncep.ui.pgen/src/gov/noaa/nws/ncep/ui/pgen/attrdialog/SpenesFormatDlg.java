...
public class SpenesFormatDlg extends CaveJFACEDialog {
     ...
     */
    private final SpenesFormatMsgDlg sfMsgDlg = null;
     ...
     */
    private final GridData singleTxtGridData = new GridData(300, 36);
     ...
     * DataType name
     */
    private static String DATATYPEARRAY[] = new String[] { "GOES-11", "GOES-12",
            "GOES-13", "GOES-15", "DPD", "IND", "Meteosat", "VAAC" };
     ...
     * @return
     */
    public static SpenesFormatDlg getInstance(Shell parentShell,
            SpenesAttrDlg spenesDlg, Spenes sp) {
        if (INSTANCE == null) {
            try {
    ...
    public void formatPressed() {
        ...
        SpenesFormatMsgDlg sfmDlg = new SpenesFormatMsgDlg(
                this.getParentShell(), SpenesFormatDlg.this);
    ...
    public void okPressed() {
        ...
        if (!err.isEmpty()) {
            ...
            copyAttrToSpenes();
            spDlg.drawingLayers.resetElement(spenes);
    ...
    private void createArea1(Group top) {
        ...
        if (spenes.getInitDateTime() == null) {
            spenes.setInitTime();
        }
    ...
    private void createArea2(Group top) {
        ...
        txtAbrv = new Text(top,
                SWT.LEFT | SWT.BORDER | SWT.WRAP | SWT.V_SCROLL);
    ...
    private void createArea3(Group top) {
        ...
        btnSatAnaTre.addListener(SWT.Selection, new Listener() {
            ...
            public void handleEvent(Event event) {
                try {
                    SpenesSATDlg SATDlg = new SpenesSATDlg(
                            SpenesFormatDlg.this.getShell());
    ...
    private void createArea5(Group top) {
        ...
        btnAddlInfo.addListener(SWT.Selection, new Listener() {
            ...
            public void handleEvent(Event event) {
                ...
                try {
                    SpenesHPDlg HPDlg = new SpenesHPDlg(
                            SpenesFormatDlg.this.getShell());
    ...
    private class SpenesSATDlg extends CaveJFACEDialog {
        private final int RESETSAT_ID = 2012062601;
        ...
        public Control createDialogArea(Composite parent) {
            ...
            txtSAT = new Text(top,
                    SWT.BORDER | SWT.MULTI | SWT.WRAP | SWT.V_SCROLL);
            txtSAT.setFont(
                    new Font(txtSAT.getDisplay(), "Courier", 12, SWT.NORMAL));
    ...
    private class SpenesHPDlg extends CaveJFACEDialog {
        ...
        private final int RESETHP_ID = 2012062602;
        ...
        public Control createDialogArea(Composite parent) {
            ...
            txtHP = new Text(top,
                    SWT.BORDER | SWT.MULTI | SWT.WRAP | SWT.V_SCROLL);
            txtHP.setFont(
                    new Font(txtHP.getDisplay(), "Courier", 12, SWT.NORMAL));
