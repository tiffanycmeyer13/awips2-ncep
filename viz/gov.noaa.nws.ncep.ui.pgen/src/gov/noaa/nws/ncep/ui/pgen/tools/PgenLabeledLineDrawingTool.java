...
public class PgenLabeledLineDrawingTool extends AbstractPgenDrawingTool
    ...
    /*
     * create a label text with out arrow. see PgenAddLabelHandler.java
     */
    private void setCcfpText(LabeledLine ll, Line ln, Text txt, Label lbl) {
        txt.setParent(lbl);
        txt.setPgenCategory("Text");
        txt.setPgenType("AVIATION_TEXT");
        ...
        txt.setLocation(ln.getCentroid());
    }
