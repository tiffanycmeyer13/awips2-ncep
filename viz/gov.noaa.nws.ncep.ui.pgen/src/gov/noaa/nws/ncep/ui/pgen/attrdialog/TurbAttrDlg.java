...
public class TurbAttrDlg extends AttrDlg implements ILine {
    ...
    /**
     * drawing tool, can be PgenLabeledLineDrawingTool or
     * PgenLabeledLineModifyTool
     */
    ...
    private static final String[] TURB_LIST = new String[] { "TURBULENCE_0",
            "TURBULENCE_1", "TURBULENCE_2", "TURBULENCE_3", "TURBULENCE_4",
            "TURBULENCE_4|TURBULENCE_6", "TURBULENCE_5", "TURBULENCE_6",
            "TURBULENCE_6|TURBULENCE_7", "TURBULENCE_7", "TURBULENCE_8" };
            ...
            public void widgetSelected(SelectionEvent e) {
                if (((Button) e.widget).getSelection()) {
                    if (turbTool != null && turbTool.getLabeledLine() != null
                            && turbTool.getLabeledLine().getLines()
                                    .size() > 0) {
    ...
    public void setAttrForDlg(IAttribute ia) {
        if (turbTool != null && turbTool.getLabeledLine() != null) {
            Iterator<DrawableElement> it = turbTool.getLabeledLine()
                    .createDEIterator();
            while (it.hasNext()) {
