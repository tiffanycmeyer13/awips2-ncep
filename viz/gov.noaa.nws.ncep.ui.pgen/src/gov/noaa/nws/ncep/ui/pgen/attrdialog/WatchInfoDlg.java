...
public class WatchInfoDlg extends CaveJFACEDialog {
    ...
    protected void initializeComponents() {
        ...
        // create "Specification", "QC counties" and "County List" radio
        // buttons.
        createRadioButtons();
    ...
    /**
     * Go through all CWAs in the list and check if all counties of each cwa are
     * in the watch box. If yes, set the IN radio button. If all counties of a
     * CWA are not in the watch box, set the OUT radio button. Otherwise, do not
     * set either button.
     */
    public void setCwaBtns() {
        ...
        for (CwaComposite cwa : cwaComp) {
            ...
            // get number of counties of a CWA, which are inside of the watch
            // box
    ...
    public void enableAllButtons(boolean flag) {
        ...
        if (wbDlg != null && wbDlg.getWatchBox() != null
            ...
            // for not issued watch, disable 'add status line' button and 'watch
            // status' button.
