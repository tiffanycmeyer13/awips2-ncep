...
/**
 * This class contains the implementation needed to add a list of Drawable
 * Element to an existing PGEN Resource.
 * 
 * <pre>
 * SOFTWARE HISTORY
 *
...
public class AddElementsCommand extends PgenCommand {
    ...
    /**
     * Constructor specifying the list, product and layer to which the elements
     * should be added.
     * 
     * @param list
     ...
     * @param elements
     *            list of drawable elements to add.
     */
