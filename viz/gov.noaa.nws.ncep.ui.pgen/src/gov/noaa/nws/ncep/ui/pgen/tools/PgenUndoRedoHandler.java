 ...
 * 12/09         R5197/TTR1056  J. Wu        Reset to the last action after
 *                                           Undo/Redo.
 * May 16, 2016  5640           bsteffen     Access button name through command
 *                                           parameter.
 * Nov 18, 2016  25955          astrakovsky  Fixed null pointer exception by
 *                                           adding an empty string check.
 * Dec 27, 2016  27572          B. Yin       Removed object handle-bars for
 *                                           Ctrl-Z.
 * Dec 02, 2021  95362          tjensen      Refactor PGEN Resource management
 *                                           to support multi-panel displays
 *
 * </pre>
 *
 * @author sgilbert
...
public class PgenUndoRedoHandler extends AbstractTool {
    ...
    public Object execute(ExecutionEvent event) throws ExecutionException {
        ...
        if (activeIcon != null && activeIcon.length() > 0
                && !activeIcon.equals("Undo") && !activeIcon.equals("Redo")) {
        ...
        PgenResourceList resources = session.getPgenResources();
        if (resources != null && resources.isEditable()) {
