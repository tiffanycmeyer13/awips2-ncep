 ...
 * 01/11         TTR381   J. Wu        Update cycle/hour for all GFA elements.
...
public class CycleDlg extends AttrDlg {
    ...
    private void initializeComponents() {
        ...
        for (int cycle : cycles) {
            cycleCbo.add(cycle < 10 ? "0" + cycle : "" + cycle);
        }
        ...
        if (drawingLayers != null) {
            ...
            for (AbstractDrawableComponent adc : drawingLayers.getActiveLayer()
                ...
                if (adc instanceof Gfa) {
                    // Remove the IDisplayable in the container to activate the
                    // redraw.
                    drawingLayers.resetElement((Gfa) adc);
