 ...
 * "PASTE" - Ctrl+V pastes all elements in PgenClipboard to the current active
 * layer. "SELECTALL" - Ctrl+A only works under "Select" and "MultiSelect"
...
public class PgenCopypasteHotkeyHandler extends AbstractHandler {
    ...
    public Object execute(ExecutionEvent event) throws ExecutionException {
        ...
        String curAction = PgenSession.getInstance().getPgenPalette()
                .getCurrentAction();

        /*
         * "CUT" - Ctrl+X only works under "Select" and "MultiSelect" Modes. It
         * copies all selected elements to PgenClipboard, then delete originals
         * from PgenResource. "COPY" - Ctrl+C copies all selected elements to
         * PgenClipboard. "PASTE" - Ctrl+V pastes all elements in PgenClipboard
         * to the current active layer. "SELECTALL" - Ctrl+A only works under
         * "Select" and "MultiSelect" Modes. It selects all elements in current
         * active layer and sends to PgenResource. No attribute dialog will be
        ...
        if (action.equalsIgnoreCase("CUT")) {
            ...
            List<AbstractDrawableComponent> elms = PgenClipboard.getInstance()
                    .getElSelected();
