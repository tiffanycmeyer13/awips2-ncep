 ...
 * 04/23/2021   89949       smanoj      Added Null Pointer check and some clean up.
 * 
 * </pre>
 * 
 * @author J. Wu
...
public abstract class GraphToGrid {
    ...
    private static String[] gridCalcParams = { "PROJ", "GRDAREA", "KXKY",
            "GGLIMS", "DISCRETE", "DLINES", "EDGEOPTS", "BOUNDS", "CATMAP" };

    private static String[] gridDisplayParams = { "CINT", "LINE", "FINT",
            "FLINE" };

    private static String[] gridOutputParams = { "HISTGRD", "PATH", "GDOUTF",
            "MAXGRD", "GDATTIM", "GVCORD", "GLEVEL", "GFUNC", "GPARM" };
    ...
    private void initializeGridParameters() {
        ...
        gridParameters = new LinkedHashMap<String, String>(
                parameterNames.size());
     ...
     * Initialize the parameter list.
     */
    public final static LinkedHashMap<String, String> loadParameters(
        ...
        String fname = null;
        if (PgenStaticDataProvider.getProvider() != null) {
            if (PgenStaticDataProvider.getProvider()
                    .getStaticFile(localizationName) != null) {
                fname = PgenStaticDataProvider.getProvider()
                        .getStaticFile(localizationName).getAbsolutePath();
            }
        }
        ...
        try {
            ...
            statusHandler.handle(Priority.ERROR,
                    "Unable to get parameters from " + thisFile + ".",
                    e);
        }
     ...
     * @return
     */
    public static String getParamValues(HashMap<String, String> map,
            String paramName) {
