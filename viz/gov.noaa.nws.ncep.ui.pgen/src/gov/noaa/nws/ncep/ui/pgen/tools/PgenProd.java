...
public class PgenProd extends AbstractPgenTool {
    ...
    private class ProdDialog extends Dialog {
        ...
        public int open() {
            ...
            this.getShell().setLocation(
                    this.getShell().getParent().getLocation().x + 30,
        ...
        public void okPressed() {
            for (Button btn : typeMap.keySet()) {
                if (btn.getSelection()) {
                    ...
                    ProdTextDlg msgDlg = new ProdTextDlg(
    ...
    private class ProdTextDlg extends Dialog {
        ...
        public int open() {
            ...
            this.getShell().setLocation(
                    this.getShell().getParent().getLocation().x + 300,
                    this.getShell().getParent().getLocation().y);
        ...
        public void okPressed() {
            ...
            if (pt.getOutputFile() != null && !pt.getOutputFile().isEmpty()) {
                ...
                if (dataURI != null) {
                    try {
                        StorageUtils.storeDerivedProduct(dataURI, name,
                                pt.getType(), message, true);
                    } catch (PgenStorageException e) {
                        StorageUtils.showError(e);
                    }
                }
