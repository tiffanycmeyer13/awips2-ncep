...
/**
 * 
 *  The class for NSHARP Wito Pane MouseHandler
 * 
 * 
 * <pre>
 * SOFTWARE HISTORY
 ...
 * @author smanoj
 */
public class NsharpWitoPaneMouseHandler extends NsharpAbstractMouseHandler {

    public NsharpWitoPaneMouseHandler(NsharpEditor editor, IDisplayPane pane) {
        super(editor, pane);
    }
