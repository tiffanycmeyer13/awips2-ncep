...
/**
 * 
 *  The class for NSHARP SPC Graphics Pane MouseHandler
 * 
 * 
 * <pre>
 * SOFTWARE HISTORY
 ...
 * @author smanoj
 */
public class NsharpSpcGraphsPaneMouseHandler
        extends NsharpAbstractMouseHandler {

    public NsharpSpcGraphsPaneMouseHandler(NsharpEditor editor,
            IDisplayPane pane) {
        super(editor, pane);
    }
