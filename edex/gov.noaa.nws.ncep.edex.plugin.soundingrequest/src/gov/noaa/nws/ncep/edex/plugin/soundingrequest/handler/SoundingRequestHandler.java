...
public class SoundingRequestHandler
        implements IRequestHandler<SoundingServiceRequest> {

    @Override
    public Object handleRequest(SoundingServiceRequest request)
            throws Exception {
        ...
        case GET_SOUNDING_DATA_GENERIC:
            switch (sndType) {
            case GRID_MODEL_SND:
                return ((Object) ModelsSoundingQuery
                        .handleGridModelDataRequest(request));
            case OBS_UAIR_SND:
                return ((Object) (ObsSoundingQuery
                        .handleNcuairDataRequest(request)));
            case OBS_BUFRUA_SND:
                return ((Object) (ObsSoundingQuery
                        .handleBufruaDataRequest(request)));
            case PFC_NAM_SND:
            case PFC_GFS_SND:
            case PFC_ARW_SND:
            case PFC_RAP_SND:
                return ((Object) (PfcSoundingQuery
                        .handlePfcDataRequest(request)));
            default:
                return null;
            }
        ...
        case GET_SOUNDING_RANGESTART_TIMELINE:
            ...
            case GRID_MODEL_SND:
                ...
                return ((Object) (ModelsSoundingQuery.getMdlSndRangeTimeLine(
                        request.getModelType(), refTimeAry[0])));
            case PFC_NAM_SND:
            case PFC_GFS_SND:
            case PFC_ARW_SND:
            case PFC_RAP_SND:
                refTimeAry = request.getRefTimeStrAry();
                return ((Object) (PfcSoundingQuery
                        .getPfcSndRangeTimeLine(sndType, refTimeAry[0])));
            default:
                return null;
            }
        case GET_SOUNDING_STATION_INFO:
            ...
            case OBS_BUFRUA_SND:
                refTimeAry = request.getRefTimeStrAry();
                return ((Object) (ObsSoundingQuery
                        .getObservedSndStnInfoCol(sndType, refTimeAry[0])));
            case PFC_NAM_SND:
            case PFC_GFS_SND:
            case PFC_ARW_SND:
            case PFC_RAP_SND:
                ...
                return ((Object) (PfcSoundingQuery.getPfcSndStnInfoCol(sndType,
                        rangeStartTimeAry[0], refTimeAry[0])));
            case GRID_MODEL_SND:
            default:
                return null;
            }
